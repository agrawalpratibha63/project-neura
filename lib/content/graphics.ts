...
export const graphicsPortfolio = {
  ...
  description:
    "Alongside AI & Machine Learning, I design modern visual identities, branding assets and marketing creatives that make digital products feel intuitive and memorable. Explore the full live vault below.",
